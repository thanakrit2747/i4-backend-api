...
// health check — ใช้เช็คว่า server + DB คุยกันได้ (เปิดสาธารณะ ไม่ต้อง login)
...
// ---- Auth routes (เปิดสาธารณะ — ต้องเข้าได้ก่อน login ถึงจะขอ token ได้) ----
app.use('/api', authRouter);

// ---- ตั้งแต่บรรทัดนี้ลงไป ทุก /api/* ต้อง login ก่อนเสมอ ----
app.use('/api', requireAuth);

// ---- Routers (ทั้งหมดถูกป้องกันด้วย requireAuth ด้านบนแล้ว) ----
